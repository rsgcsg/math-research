...
## 2026-09-22：E105 / C024，已经运行全词定价，不再只有准备

[证明、实际运行与范围](docs/proofs/full_law_pricing.md)：三种全十五域模式主问题／合法色词查询，
共30个新合法词，逐轮整数池分离与反例独立重放；最终池均仍不可混合，**不是全词不可行**。
新增最小四点C024：每个运动单独可二色joint，但两个运动共同无解；直接编译实际C₅。
`make check-pricing` 无需搜索依赖，重放有限证据、405个小查询校准及篡改拒绝。
本轮没有15域正律、全词负证据或普通HN新界。以下2026-09-21段落保留为历史准备状态。
